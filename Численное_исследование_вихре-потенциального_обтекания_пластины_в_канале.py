...
participants = [
    ...
    {"name": "Александр Романенко", "photo": "1.jpg", "role": "Верификация численного решения симметричного обтекания при аппроксимации полиномами степени p = 1,2,3, при трех значениях циркуляции Г, при трех значениях полувысоты пластины h."},
